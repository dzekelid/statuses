...
- name: Azure Resource Health API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/statuses/master/_listings/azure-resource-health/resourceuri-providers-microsoft-resourcehealth-availabilitystatuses-current-get.md
x-common:
- type: x-faq
