...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/aws-data-pipeline/apis.md
...
- name: AWS Data Pipeline API - Set Status
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/aws-data-pipeline/actionsetstatus-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/aws-data-pipeline/actionsetstatus-get-openapi.md
- name: AWS Data Pipeline API - Set Status
  x-api-slug: actionsetstatus-get
  description: Requests that the status of the specified physical or logical pipeline
    objects be updated in the specified pipeline.
...
- name: AWS Data Pipeline API - Set Task Status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/aws-data-pipeline/actionsettaskstatus-get-openapi.md
- name: AWS Data Pipeline API - Set Status
  x-api-slug: actionsetstatus-get
  description: Requests that the status of the specified physical or logical pipeline
    objects be updated in the specified pipeline.
