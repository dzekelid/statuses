...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/google-partners/apis.md
...
- name: Google Partners - Get Partner Status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/google-partners/v2partnersstatus-get-openapi.md
- name: Google Partners - Get Partner Status
  x-api-slug: v2partnersstatus-get
  description: |-
    Gets Partners Status of the logged in user's agency.
