...
- name: Bitbucket Parameters Repositories Username Repo Slug Pullrequests Pull Request  Statuses
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/bitbucket/repositories-username-repo-slug-pullrequests-pull-request-id-statuses-parameters-postman.md
x-common:
- type: x-developer
