...
- name: Bitbucket Parameters Repositories Username Repo Slug Commit Node Statuses
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/bitbucket/repositories-username-repo-slug-commit-node-statuses-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/bitbucket/repositories-username-repo-slug-commit-node-statuses-parameters-postman.md
x-common:
- type: x-developer
