...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/statuses/master/_listings/bitbucket/repositories-username-repo-slug-commit-node-statuses-build-key-put.md
x-common:
- type: x-developer
