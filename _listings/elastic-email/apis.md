...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/elastic-email/apis.md
specificationVersion: "0.14"
apis:
- name: Elastic Email SMTP API - Log Activity
  x-api-slug: mailerstatuslog-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/elastic-email/mailerstatuslog-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/elastic-email/mailerstatuslog-get-openapi.md
- name: Elastic Email SMTP API - Get Status
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/elastic-email/mailerstatusmessage-id-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/elastic-email/mailerstatusmessage-id-get-openapi.md
- name: Elastic Email SMTP API - Log Activity
  x-api-slug: mailerstatuslog-get
  description: The detailed activity log api allows you to get detailed information
    from your activity log on the emails that you have sent. Information can be narrowed
