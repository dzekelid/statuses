...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/tigertext/apis.md
...
- name: Tiger Connect Message API - Update the status of a message or several messages.
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/tigertext/messagestatus-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/tigertext/messagestatus-put-openapi.md
- name: Tiger Connect Message API - Update the status of a message or several messages.
  x-api-slug: messagestatus-put
  description: Update the status of a message or several messages.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/tigertext-logo.png
