...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/xignite/apis.md
...
- name: Xignite Futures - Get All Historical Futures With Status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/xignite/getallhistoricalfutureswithstatus-get-openapi.md
- name: Xignite Futures - Get All Historical Futures With Status
  x-api-slug: getallhistoricalfutureswithstatus-get
  description: Returns historical quotes for all contracts for a commodity as of a
    specific date including status information.
...
- name: Xignite IPOs - Get IPO By Status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/xignite/getipobystatus-get-openapi.md
- name: Xignite IPOs - Get IPO By Status
  x-api-slug: getipobystatus-get
  description: Post getipobystatus
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/xignite-logo.png
