...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/rebilly/apis.md
...
- name: Rebilly - Retrieve API current status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/rebilly/status-get-openapi.md
- name: Rebilly - Retrieve API current status
  x-api-slug: status-get
  description: Retrieve API current status
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/rebilly.png
