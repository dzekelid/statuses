...
- name: Twitter Show Retweets
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/twitter/statuses-retweets-id-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/twitter/statuses-retweets-id-post-postman.md
x-common:
- type: x-net-library
