...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/quovo/apis.md
...
- name: Quovo API v3 - Check a user's TOU status
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/quovo/usersuser-idterms-of-use-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/quovo/usersuser-idterms-of-use-get-openapi.md
- name: Quovo API v3 - Update a user's TOU status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/quovo/usersuser-idterms-of-use-put-openapi.md
- name: Quovo API v3 - Check a user's TOU status
  x-api-slug: usersuser-idterms-of-use-get
  description: "Check whether or not a User has accepted Quovo\u2019s terms of use."
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28293-quovo.jpg
