...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/ibm-cloud/apis.md
...
- name: IBM Containers - List the current state of a container.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/statuses/master/_listings/ibm-cloud/containersidstatus-get-openapi.md
- name: IBM Containers - List the current state of a container.
  x-api-slug: containersidstatus-get
  description: This endpoint returns the current state of a container. This state
    can either be a transient state, such as BUILDING and NETWORKING, or a non-transient
